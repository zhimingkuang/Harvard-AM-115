...
% USAGE
%   [ssim,xsim] = dpsimul_discrete_action(model,ss,nper,sres,xres)
% INPUTS
...
function [ssim,xsim] = dpsimul_discrete_action(model,ss,nper,sres,xres)
