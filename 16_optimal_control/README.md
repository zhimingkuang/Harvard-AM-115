...
Open Matlab Online (requires login) [https://matlab.mathworks.com/](https://matlab.mathworks.com/) or open your local Matlab installation.

At the Command Window, type:
gitclone("https://github.com/zhimingkuang/Harvard-AM-115.git")

This clones the AM115 repository and you are set up to use the [CompEcon toolbox](https://pfackler.wordpress.ncsu.edu/compecon-download/). The instructions for downloading the toolbox (instead of the whole repository) onto your own computer can be found in Canvas (Instructions on downloading and using the dynamic programming code by Fackler.pdf)
